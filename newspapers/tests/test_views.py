...
class ViewsTestCase(TestCase):
    def setUp(self):
        ...
        self.redactor = Redactor.objects.create(username='redactor', years_of_experience=5)

    def test_newspaper_create_view(self):
        self.client.force_login(self.user)
        response = self.client.post(reverse('newspapers:newspapers-create'), {'title': 'Test', 'content': 'Test Content', 'topic': 1})
