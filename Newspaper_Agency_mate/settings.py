"""
Django settings for Newspaper_Agency_mate project.
...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", 'django-insecure-dj#*4*+$yn8y*5cr0@e$a$!0p$(^k!1478wqmbatg54a@7&uci')
...
#     }
# }
load_dotenv('Newspaper_Agency_mate/.env')
DATABASES = {
  'default': {
